...
private static final String MAIL_TYPE = "smtp";
	...
	private static final String MAIL_SUBJECT = "订单申请结果反馈";
	
	private static final String MAIL_FRONNAME = "QINKER COMPANY";
	
	public static void sendMail(String receiveMail,String mailContent,String receiveName,String file) throws Exception {
		...
		MimeMessage message = createMimeMessage(file,session, MAIL_SEND_MAIL_ACCOUNT, receiveMail,receiveName,mailContent);
	...
	public static MimeMessage createMimeMessage(String file,Session session, String sendMail, String receiveMail,String receiveName,String mailContent) throws Exception {
        // 1. 创建一封邮件
