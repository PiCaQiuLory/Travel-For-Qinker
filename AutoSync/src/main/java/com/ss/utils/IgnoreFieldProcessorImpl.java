...
public class IgnoreFieldProcessorImpl implements PropertyFilter {
	...
	public static JSONObject JsonConfig(String[] configs, Object entity) {
		...
		config.setJsonPropertyFilter(new IgnoreFieldProcessorImpl(true, configs)); // 保留的属性<span style="font-family:
																					// Arial, Helvetica,
																					// sans-serif;">configs</span>
	...
	public static JSONArray ArrayJsonConfig(String[] configs, Object entity) {
		JsonConfig config = new JsonConfig();
		config.setJsonPropertyFilter(new IgnoreFieldProcessorImpl(true, configs)); // <span style="font-family: Arial,
																					// Helvetica,
																					// sans-serif;">保留的属性</span><span
